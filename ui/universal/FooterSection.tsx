import { expertise, whoWeAre } from '#/lib/mockData';
import Link from 'next/link';

const FooterSection = () => {
  return (
    <div className="w-full px-24 py-6 bg-white/5 backdrop-blur-lg ">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div className="mt-6">
            <ul>
              {whoWeAre.map((item, index) => {
                return (
                  <li
                    className="mb-2 text-gray-800 hover:underline-offset-2 hover:underline"
                    key={index}
                  >
        ...
        <div className="mx-auto">
          <h2 className="text-xl font-medium">Our Expertise</h2>
          <div className="mt-6 ">
            <ul>
