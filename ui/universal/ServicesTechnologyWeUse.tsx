...
import { TechnologyCardType } from './types';
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col content-center items-center w-full md:w-[70%] pt-10">
        ...
        <div className="bg-blue-300 min-h-[60px] h-full w-full" style={{ width: '50%' }}>
          <img src={cardImage} className="w-full aspect-ratio:1/1" />
        </div>
      </div>
    </div>
  );
